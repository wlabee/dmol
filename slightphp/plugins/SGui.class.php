...
class SGui extends Smarty {
     ...
     * render a .tpl
     */
    public function render($tpl, $parames = array(), $config = array()) {
        ...
        $this->compile_dir = SlightPHP::$appDir . DIRECTORY_SEPARATOR . "templates_c" . DIRECTORY_SEPARATOR . $config['compile_dir'];
        $this->template_dir = SlightPHP::$appDir . DIRECTORY_SEPARATOR . "templates" . DIRECTORY_SEPARATOR . $config['template_dir'];
        if ($this->_tplParams) {
            $parames = array_merge($parames, $this->_tplParams);
        }
